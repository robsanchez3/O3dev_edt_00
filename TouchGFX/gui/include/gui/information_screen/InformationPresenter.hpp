...
public:
    ...
    Unicode::UnicodeChar * getSoftwareVersion();
    Unicode::UnicodeChar * getControlSoftwareVersion();
    int16_t getPressure();
    int16_t getTemperature();
    Unicode::UnicodeChar * getParameters();
    Unicode::UnicodeChar * getStartupInfo();
private:
