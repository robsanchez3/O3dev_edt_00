...
enum SCREEN_ID {SID_NON, SID_ERROR, SID_MAIN_MENU, SID_STARTING, SID_RUNNING, SID_END, SID_WASHING, SID_SYRINGE_FILL, SID_ADJUSTING, SID_CALIBRATION, SID_DEV_UPDATE};
