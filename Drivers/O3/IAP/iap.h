...
#define IAP_APP_FIRST_BLK   0x0017u    /* first writable block id */
#define IAP_APP_LAST_BLK    0x01F8u    /* one past last writable */
...
/* 0xBB 0x04 -> <XOR> ACK. Returns 8-bit XOR of flash [0x05C0, 0x7E00) in    *
