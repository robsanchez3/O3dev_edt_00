...
#define APP_FIRST_BYTE  ((uint32_t)IAP_APP_FIRST_BLK * IAP_BLOCK_SIZE)  /* 0x05C0 */
#define APP_LAST_BYTE   ((uint32_t)IAP_APP_LAST_BLK  * IAP_BLOCK_SIZE)  /* 0x7E00 */
#define APP_SIZE        (APP_LAST_BYTE - APP_FIRST_BYTE)                 /* 30784  */
#define BLOCKS_IN_APP   ((size_t)(APP_SIZE / IAP_BLOCK_SIZE))            /* 481    */
